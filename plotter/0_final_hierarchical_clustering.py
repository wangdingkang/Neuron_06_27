...
output_folder = 'silhoutte_results//Hierarchical//'
cluster_folder = 'cluster_labels//Hierarchical//'
cluster_lfolder = 'cluster_indexes//'
...
for file in files:
    ...
    for n_clusters in range_n_clusters:
        ...
        # Hierarchical clustering, l1 distance, and complete linkage.
        clusterer = AgglomerativeClustering(n_clusters=n_clusters, affinity='l1', linkage='complete')
        cluster_labels = clusterer.fit_predict(X)

        cluster_subfolder = str(n_clusters) + '//'
        cluster_tfolder = os.path.join(cluster_lfolder, cluster_subfolder)
        ...
        np.savetxt(cluster_filename, cluster_labels, fmt='%d', delimiter=' ')
